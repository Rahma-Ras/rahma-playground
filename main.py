from crud_operations import PostCRUD


def display_menu():
    print("\n" + "=" * 50)
    print("📝 POST & COMMENTS CRUD APPLICATION")
    print("=" * 50)
    print("1. Create Post")
...
def main():
    ...
    crud.create_post("Welcome to my blog", "This is my first blog post!", "John Doe")
    crud.create_post("Python Tips", "Here are some useful Python tips...", "Jane Smith")
    ...
    while True:
        ...
        if choice == '1':
            ...
            crud.read_all_posts()  # Show available posts first
            try:
            ...
            print("👋 Thank you for using the CRUD app! Goodbye!")
            break
